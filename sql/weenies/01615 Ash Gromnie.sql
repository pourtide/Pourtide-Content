...
VALUES (1615, 'gromnieash', 10, '2022-06-02 17:00:34') /* Creature */;
...
VALUES (1615,   1,       5) /* HeartbeatInterval */
     ...
     , (1615,  16, 0.10999999940395355) /* ArmorModVsCold */
     , (1615,  17, 0.10999999940395355) /* ArmorModVsFire */
     , (1615,  18, 0.10999999940395355) /* ArmorModVsAcid */
     , (1615,  19, 0.10999999940395355) /* ArmorModVsElectric */
     , (1615,  31,      25) /* VisualAwarenessRange */
     , (1615,  34, 1.2000000476837158) /* PowerupTime */
...
VALUES (1615,   1,  10, 0, 0) /* Strength */
     , (1615,   2, 100, 0, 0) /* Endurance */
     , (1615,   3,  10, 0, 0) /* Quickness */
     , (1615,   4,  10, 0, 0) /* Coordination */
     , (1615,   5,  70, 0, 0) /* Focus */
     , (1615,   6,  50, 0, 0) /* Self */;

INSERT INTO `weenie_properties_attribute_2nd` (`object_Id`, `type`, `init_Level`, `level_From_C_P`, `c_P_Spent`, `current_Level`)
VALUES (1615,   1,    20, 0, 0, 90) /* MaxHealth */
     , (1615,   3,     0, 0, 0, 100) /* MaxStamina */
     , (1615,   5,     0, 0, 0, 50) /* MaxMana */;

INSERT INTO `weenie_properties_skill` (`object_Id`, `type`, `level_From_P_P`, `s_a_c`, `p_p`, `init_Level`, `resistance_At_Last_Check`, `last_Used_Time`)
VALUES (1615,  6, 0, 3, 0,   0, 0, 0) /* MeleeDefense        Specialized */
     , (1615,  7, 0, 3, 0,   0, 0, 0) /* MissileDefense      Specialized */
     , (1615, 13, 0, 3, 0,  80, 0, 0) /* UnarmedCombat       Specialized */
     , (1615, 15, 0, 3, 0,   0, 0, 0) /* MagicDefense        Specialized */
...
{
  "LastModified": "2022-06-02T09:58:11.9993563-07:00",
  "ModifiedBy": "pourman",
  "Changelog": [
    {
    ...
    },
    {
      "created": "0001-01-01T00:00:00",
      "author": "CrimsonMage",
      "comment": "Scripted updates of Mob Jsons.\r\n- Updated all bool, did, float, int, and string Stats to match with PCAP.\r\n- Levels and Experience points updated to match EoR XP table.\r\n- Level 80 mobs have updated Red/Gold letters.\r\n- Primary/secondary attributes validated against Pcap.\r\n============\r\n-Updated Int 3 to proper color"
    },
    {
      "created": "0001-01-01T00:00:00",
      "author": "Zarto ",
      "comment": "-Updated palette INT to 3 (yotes determined value for this setup/clothing DID and WCID"
    },
    {
      "created": "0001-01-01T00:00:00",
      "author": "Zarto ",
