...
INSERT INTO `landblock_instance` (`guid`, `weenie_Class_Id`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`, `is_Link_Child`, `last_Modified`)
VALUES (0x73415008,  7924, 0x34150000, 156.199, 59.157, 84.005, -0.999991, 0, 0, 0.004284, False, '2005-02-09 10:00:00'); /* Linkable Monster Generator ( 5 Min.) */
...
INSERT INTO `landblock_instance` (`guid`, `weenie_Class_Id`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`, `is_Link_Child`, `last_Modified`)
VALUES (0x7341500A,  8138, 0x34150000, 156.412, 102.244, 84.01, -0.99999, 0, 0, 0.004396,  True, '2005-02-09 10:00:00'); /* Extas Raider */
